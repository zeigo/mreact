...
import { diffProperties } from "../Utils/Property"
import { listenTo } from "../Event/EventEmitter"
import { registrationNameModule } from "../Event/EventPluginRegistry"
...
function setInitialDOMProperties(tag, domElement, props) {
  for (let propKey in props) {
    ...
    } else if (propKey === "children") { // children只有text
      if (typeof prop === "string" || typeof prop === "number") {
        domElement.innerHTML = "" + prop // textContent
      }
    } else if (registrationNameModule.hasOwnProperty(propKey)) {
      listenTo(propKey)
    }
  }
}